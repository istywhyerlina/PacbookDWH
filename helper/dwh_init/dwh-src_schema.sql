...
ALTER TABLE ONLY pacbook.address_status
    ADD CONSTRAINT pk_addr_status PRIMARY KEY (status_id);


--
-- Name: address pk_address; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.address
    ADD CONSTRAINT pk_address PRIMARY KEY (address_id);


--
-- Name: author pk_author; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.author
    ADD CONSTRAINT pk_author PRIMARY KEY (author_id);


--
-- Name: book pk_book; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.book
    ADD CONSTRAINT pk_book PRIMARY KEY (book_id);


--
-- Name: book_author pk_bookauthor; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.book_author
    ADD CONSTRAINT pk_bookauthor PRIMARY KEY (book_id, author_id);


--
-- Name: country pk_country; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.country
    ADD CONSTRAINT pk_country PRIMARY KEY (country_id);


--
-- Name: customer_address pk_custaddr; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.customer_address
    ADD CONSTRAINT pk_custaddr PRIMARY KEY (customer_id, address_id);


--
-- Name: customer pk_customer; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.customer
    ADD CONSTRAINT pk_customer PRIMARY KEY (customer_id);


--
-- Name: cust_order pk_custorder; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.cust_order
    ADD CONSTRAINT pk_custorder PRIMARY KEY (order_id);


--
-- Name: book_language pk_language; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.book_language
    ADD CONSTRAINT pk_language PRIMARY KEY (language_id);


--
-- Name: order_history pk_orderhist; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.order_history
    ADD CONSTRAINT pk_orderhist PRIMARY KEY (history_id);


--
-- Name: order_line pk_orderline; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.order_line
    ADD CONSTRAINT pk_orderline PRIMARY KEY (line_id);


--
-- Name: order_status pk_orderstatus; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.order_status
    ADD CONSTRAINT pk_orderstatus PRIMARY KEY (status_id);


--
-- Name: publisher pk_publisher; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.publisher
    ADD CONSTRAINT pk_publisher PRIMARY KEY (publisher_id);


--
-- Name: shipping_method pk_shipmethod; Type: CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.shipping_method
    ADD CONSTRAINT pk_shipmethod PRIMARY KEY (method_id);


--
-- Name: address fk_addr_ctry; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.address
    ADD CONSTRAINT fk_addr_ctry FOREIGN KEY (country_id) REFERENCES pacbook.country(country_id);


--
-- Name: book_author fk_ba_author; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.book_author
    ADD CONSTRAINT fk_ba_author FOREIGN KEY (author_id) REFERENCES pacbook.author(author_id);


--
-- Name: book_author fk_ba_book; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.book_author
    ADD CONSTRAINT fk_ba_book FOREIGN KEY (book_id) REFERENCES pacbook.book(book_id);


--
-- Name: book fk_book_lang; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.book
    ADD CONSTRAINT fk_book_lang FOREIGN KEY (language_id) REFERENCES pacbook.book_language(language_id);


--
-- Name: book fk_book_pub; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.book
    ADD CONSTRAINT fk_book_pub FOREIGN KEY (publisher_id) REFERENCES pacbook.publisher(publisher_id);


--
-- Name: customer_address fk_ca_addr; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.customer_address
    ADD CONSTRAINT fk_ca_addr FOREIGN KEY (address_id) REFERENCES pacbook.address(address_id);


--
-- Name: customer_address fk_ca_cust; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.customer_address
    ADD CONSTRAINT fk_ca_cust FOREIGN KEY (customer_id) REFERENCES pacbook.customer(customer_id);


--
-- Name: order_history fk_oh_order; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.order_history
    ADD CONSTRAINT fk_oh_order FOREIGN KEY (order_id) REFERENCES pacbook.cust_order(order_id);


--
-- Name: order_history fk_oh_status; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.order_history
    ADD CONSTRAINT fk_oh_status FOREIGN KEY (status_id) REFERENCES pacbook.order_status(status_id);


--
-- Name: order_line fk_ol_book; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.order_line
    ADD CONSTRAINT fk_ol_book FOREIGN KEY (book_id) REFERENCES pacbook.book(book_id);


--
-- Name: order_line fk_ol_order; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.order_line
    ADD CONSTRAINT fk_ol_order FOREIGN KEY (order_id) REFERENCES pacbook.cust_order(order_id);


--
-- Name: cust_order fk_order_addr; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.cust_order
    ADD CONSTRAINT fk_order_addr FOREIGN KEY (dest_address_id) REFERENCES pacbook.address(address_id);


--
-- Name: cust_order fk_order_cust; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.cust_order
    ADD CONSTRAINT fk_order_cust FOREIGN KEY (customer_id) REFERENCES pacbook.customer(customer_id);


--
-- Name: cust_order fk_order_ship; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.cust_order
    ADD CONSTRAINT fk_order_ship FOREIGN KEY (shipping_method_id) REFERENCES pacbook.shipping_method(method_id);


--
-- Name: customer_address fkey_status_add; Type: FK CONSTRAINT; Schema: pacbook; Owner: postgres
--

ALTER TABLE ONLY pacbook.customer_address
    ADD CONSTRAINT fkey_status_add FOREIGN KEY (status_id) REFERENCES pacbook.address_status(status_id);
